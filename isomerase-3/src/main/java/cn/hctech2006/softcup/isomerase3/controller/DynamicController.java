...
import cn.hctech2006.softcup.isomerase3.service.impl.DynamicServiceImpl;
...
//    })
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(type = "query", name = "dataSourceName", value = "数据库使用名", required = true, defaultValue = "酒店"),
    ...
    public ServerResponse queryOrStorage(String username, String password, String url
        ...
        return dynamicService.queryOrStorage(username,password, url, databaseType,dataSourceName);
    }
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(type = "query", name = "tableName", value = "数据表名", defaultValue = "", required = true),
    })
