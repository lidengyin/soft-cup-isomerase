...
@ApiModel(description = "数据模型分页模型对象")
public class ModelPageInfoVO {
    ...
    public List<ModelListVO> getModelListVOS() {
        return modelListVOS;
    }

    public void setModelListVOS(List<ModelListVO> modelListVOS) {
        this.modelListVOS = modelListVOS;
    }
