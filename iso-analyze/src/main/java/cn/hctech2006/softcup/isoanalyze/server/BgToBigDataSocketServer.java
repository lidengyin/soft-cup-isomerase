package cn.hctech2006.softcup.isoanalyze.server;
...
@ServerEndpoint("/bg_to_bigdata")
@Component
public class BgToBigDataSocketServer {
    ...
    public static void sendAll(Map<String, Object> message){
